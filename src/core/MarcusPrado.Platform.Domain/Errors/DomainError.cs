...
public static class DomainError
{
    ...
    /// </summary>
    public static Error BusinessRuleViolation(string aggregateName, string rule, string message) =>
        Error
            .Validation(code: $"{Normalise(aggregateName)}.BUSINESS_RULE_VIOLATION", message: message)
            .WithMetadata("aggregateName", aggregateName)
    ...
    /// </summary>
    public static Error InvalidStateTransition(string aggregateName, object currentState, object targetState) =>
        Error
            .Validation(
