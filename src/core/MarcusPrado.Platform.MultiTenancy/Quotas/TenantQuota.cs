...
public sealed record TenantQuota(int MaxRequestsPerMinute, long MaxStorageBytes)
{
    ...
    public static TenantQuota Unlimited { get; } =
        new(MaxRequestsPerMinute: int.MaxValue, MaxStorageBytes: long.MaxValue);
