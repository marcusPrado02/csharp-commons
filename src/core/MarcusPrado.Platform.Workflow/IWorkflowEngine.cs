...
public interface IWorkflowEngine
{
    ...
    Task<Result<WorkflowInstance>> CompensateAsync(Guid workflowId, CancellationToken ct = default);

    /// <summary>Cancels a running workflow instance.</summary>
    Task<Result<WorkflowInstance>> CancelAsync(Guid workflowId, string reason = "", CancellationToken ct = default);
