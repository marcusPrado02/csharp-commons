...
{
    private static readonly string[] _permissionClaimTypes = ["permission", "permissions"];
    ...
    )
    {
        ...
        var hasPermission = _permissionClaimTypes.Any(t => context.User.HasClaim(t, required));
