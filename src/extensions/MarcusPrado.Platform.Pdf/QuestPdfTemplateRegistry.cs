...
{
    private readonly Dictionary<string, Action<PageDescriptor, object>> _composers =
        new(StringComparer.OrdinalIgnoreCase);

    /// <summary>Registers a named template composer.</summary>
    public QuestPdfTemplateRegistry Register(
        string templateName,
        Action<PageDescriptor, object> composer)
    {
    ...
    public bool TryGetComposer(
        string templateName,
        out Action<PageDescriptor, object>? composer)
