...
public static class TestDataScenarios
{
    ...
    public static TenantScenario FreeTenant => new(
    ...
    public static TenantScenario PremiumTenant => new(
        TenantId: Guid.NewGuid().ToString("N"),
    ...
    public static TenantScenario SuspendedTenant => new(
        TenantId: Guid.NewGuid().ToString("N"),
    ...
    public static UserScenario ValidUser => new(
    ...
    public static UserScenario AnonymousUser => new(
        UserId: null,
        Email: null,
        Permissions: [],
        Scopes: [],
    ...
    public static SubscriptionScenario ExpiredSubscription => new(
    ...
    public static SubscriptionScenario ActiveSubscription => new(
        SubscriptionId: Guid.NewGuid(),
        Plan: "premium",
...
public sealed record TenantScenario(
    string TenantId,
    string Name,
    string Plan,
    bool IsActive);
...
public sealed record SubscriptionScenario(
    Guid SubscriptionId,
    string Plan,
