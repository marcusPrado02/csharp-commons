...
public sealed class NamingConventionRules
{
    ...
    public void ExceptionClasses_ShouldHaveNameEndingWith_Exception()
    {
        ...
        violations.Should().BeEmpty(because: "all exception classes must end with 'Exception' for discoverability");
    }
    ...
    public void Application_ExceptionClasses_ShouldInheritAppException()
    {
        ...
        violations
            .Should()
            .BeEmpty(because: "all concrete exception classes in Application must inherit AppException (APP-07)");
    }
    ...
    public void CommandHandlerClasses_ShouldHaveNameEndingWith_Handler()
    {
        ...
        violations.Should().BeEmpty(because: "all ICommandHandler implementations must have names ending in 'Handler'");
    }
    ...
    public void QueryHandlerClasses_ShouldHaveNameEndingWith_Handler()
    {
        ...
        violations.Should().BeEmpty(because: "all IQueryHandler implementations must have names ending in 'Handler'");
    }
    ...
    public void CommandClasses_ShouldHaveNameEndingWith_Command()
    {
        ...
        violations.Should().BeEmpty(because: "all ICommand implementations must have names ending in 'Command'");
    }
    ...
    public void QueryClasses_ShouldHaveNameEndingWith_Query()
    {
        ...
        violations.Should().BeEmpty(because: "all IQuery implementations must have names ending in 'Query'");
    }
}
